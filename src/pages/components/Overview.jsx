    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          >
            Real-time health, risk, and structural metrics.
          </p>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-lg font-medium text-sm transition-all hover:opacity-90 disabled:cursor-not-allowed"
        >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <HudCard
          ...
          icon={ShieldAlert}
          color={
            summary.security_issues > 0 ? 'text-red-500' : 'text-green-500'
          }
        />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div
          ...
          className="lg:col-span-2 rounded-xl p-6 flex flex-col transition-colors duration-300 border"
        >
          <div
            style={{ color: 'var(--text-primary)' }}
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 space-y-5">
              <ProgressBar
                ...
                value={summary.structure_score || 0}
              />
              <ProgressBar
                label="Test Coverage"
                value={summary.test_coverage_ratio * 100 || 0}
                reverseColors
              />
              ...
              >
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span
                    ...
                    className="font-mono"
                  >
                    {(summary.avg_duplication * 100 || 0).toFixed(2)}%
                  </span>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              className="md:w-80 rounded-lg p-5 flex flex-col justify-center space-y-6 transition-colors duration-300 border"
            >
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="col-span-2">
                  ...
                  <p
                    ...
                    className="text-lg font-mono"
                  >
                    {summary.folder_entropy?.toFixed(2) || '—'}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6">
          <motion.div
            ...
            className="rounded-xl p-5 relative overflow-hidden transition-colors duration-300 border"
          >
            ...
            {summary.critical_file ? (
              ...
              >
                ...
                <div className="flex justify-between items-center text-xs">
                  <span style={{ color: '#fc3f5e' }} className="font-bold">
                    Risk Score:{' '}
                    {(summary.critical_file.risk_score * 100).toFixed(0)}%
                  </span>
                </div>
              </div>
            ) : (
            ...
            {summary.top_recommendation && (
              ...
              >
                ...
                >
                  {summary.top_recommendation.title}
                </h4>
                <p
                  style={{ color: 'var(--text-secondary)' }}
                  className="text-xs mt-1 line-clamp-2"
                >
                  {summary.top_recommendation.description}
                </p>
              </div>
            )}
          </motion.div>
          ...
          <motion.div
            ...
            className="rounded-xl p-5 transition-colors duration-300 border"
          >
            <h3
              style={{ color: 'var(--text-primary)' }}
              className="text-sm font-bold flex items-center gap-2 mb-4"
            ...
            <div className="space-y-3">
              <RiskBar
                ...
                percent={summary.risk_distribution?.high_percent || 0}
                color="bg-red-500"
              />
              <RiskBar
                label="Medium Risk Files"
                percent={summary.risk_distribution?.medium_percent || 0}
                color="bg-orange-400"
              />
              <RiskBar
                label="Low Risk Files"
                percent={summary.risk_distribution?.low_percent || 0}
                color="bg-green-500"
              />
            </div>
          </motion.div>
...
function HudCard({ label, value, sub, icon: Icon, color }) {
  return (
    <div
      ...
      className="border p-4 rounded-xl flex items-center justify-between shadow-lg transition-colors duration-300"
    >
      <div>
        <p
          style={{ color: 'var(--text-secondary)' }}
...
function ProgressBar({ label, value, reverseColors = false }) {
  ...
  if (safeValue > 70)
    colorClass = reverseColors ? 'bg-red-500' : 'bg-green-500';
  ...
  return (
    <div>
      <div className="flex justify-between text-[10px] uppercase font-mono mb-1">
        <span style={{ color: 'var(--text-secondary)' }}>{label}</span>
        <span style={{ color: 'var(--text-primary)' }}>{safePercent}%</span>
      </div>
      <div
        style={{ backgroundColor: 'rgba(139, 92, 246, 0.1)' }}
